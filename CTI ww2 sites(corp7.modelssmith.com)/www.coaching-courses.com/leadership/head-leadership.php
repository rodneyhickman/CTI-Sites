...
<link rel="stylesheet" type="text/css" href="/res/css/section_leadership.css" />
...
$("#main-nav a[href*=leadership]").parent().addClass('current');
$("#visual2").hide();
...
$("#click2").click( function(){
  ...
  <script type="text/javascript">
	...
	<body>
		...
		<div id="page">  <!-- this ends in a foot* file -->
			
 <?php include('header-site.php'); ?>

			<div id="primary">  <!-- this ends in a foot* file -->
			
 <?php include('header-contact-nav-site.php'); ?>

 <?php include('main-nav-site.php'); ?>

 <?php include('banner-image-leadership.php'); ?>
	<!-- NOTE: index pages should use a different file -->


<?php include('subnav-leadership.php'); ?>
