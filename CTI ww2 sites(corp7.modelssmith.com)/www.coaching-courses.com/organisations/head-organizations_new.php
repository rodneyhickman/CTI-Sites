...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../../res/css/section_organisations.css" />

		<link rel="stylesheet" type="text/css" href="../../res/css/content_internal_11.css" />
		<link rel="stylesheet" type="text/css" href="/res/css/testimonial.css" />  <!-- added for profiles -->
...
$("#main-nav a[href*='coach-training']").parent().addClass('current');
});
</script>
 ...
 <?php include('banner-image-organizations.php'); ?>
	<!-- NOTE: index pages should use a different file -->


<?php include('subnav-organizations.php'); ?>
