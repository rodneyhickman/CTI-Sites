...
<link rel="stylesheet" type="text/css" href="/res/css/content_internal_3b.css" />
		
<link rel="stylesheet" type="text/css" href="/res/css/testimonial.css" />
  ...
  <script type="text/javascript">
	...
	<body>
		...
		<div id="page">
			...
			<div id="tools">
<!-- start include -->
<?php include '/www/uk.techcoachtom.com/docs/coach-training/profiles-and-testimonials/BB_header-grey-bar.html'; ?>
<!-- end include -->
			</div>
...
<!-- -->
				...
				<ul id="main-nav">  <!-- main navigation -->
<!-- start include -->
<?php include '/www/uk.techcoachtom.com/docs/coach-training/profiles-and-testimonials/BB_main-nav.html'; ?>
<!-- end include -->
				</ul>
				...
				<div id="broadcast">
					...
					<!-- MADE IMAGE SOURCE ABSOLUTE -->
					<img src="/res/img/page-banners/content_coach-training.gif" width="920" height="124" alt="For Organizations" usemap="#logobutton" />
...
<!-- start include -->
<?php include '/www/uk.techcoachtom.com/docs/coach-training/BB_section-nav.html'; ?>
<!-- end include -->
  </ul>
