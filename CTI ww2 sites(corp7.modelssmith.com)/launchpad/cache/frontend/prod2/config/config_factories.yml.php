...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/www/ww2.thecoaches.com/launchpad/log/frontend_prod2.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/www/ww2.thecoaches.com/launchpad/cache/frontend/prod2/i18n',
  'lifetime' => 31556926,
  'prefix' => '/www/ww2.thecoaches.com/launchpad/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('launchpad_cookie'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/www/ww2.thecoaches.com/launchpad/cache/frontend/prod2/template',
  'lifetime' => 86400,
  'prefix' => '/www/ww2.thecoaches.com/launchpad/apps/frontend/template',
)));
