...
<!-- This file contains the MCC Step 2 form           -->
<!--  from document: LPQuestionnaire-R1stand alone.doc  -->
      ...
      <div class="dabblePageRightShadow">
        ...
        "dabblePage dabblePageWithLogo dabbleSearchPage">
          <div class="dabblePageHeader" id="dabblePageTop">
            ...
            <h1>Retreat Questionnaire <?php if($role == 'assistant'){ echo "(Assistant)"; } ?></h1>
                ...
                <div class="dabblePageColumn dabblePageColumn1">
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      ...
                      begins here. Please use this retreat
                ...
                <div class="dabblePageColumn dabblePageColumn1">
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[goals]"><?php if(isset($pq)){ echo $pq->getPersonalProfessionalGoals(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[strengths]"><?php if(isset($pq)){ echo $pq->getStrengths(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[sabateurs]"><?php if(isset($pq)){ echo $pq->getHoldsYouBack(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      <p>This is a retreat that will push you to
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[failure]"><?php if(isset($pq)){ echo $pq->getHandleFailing(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      name="questionnaire[willingness]"><?php if(isset($pq)){ echo $pq->getWillingToFail(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      <p>In this retreat, your leaders and colleagues will give you specific and direct feedback, in service of your growth as a leader. Sometimes, this "truth" may be hard to hear. Will you listen? Please explain.</p>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[truth]"><?php if(isset($pq)){ echo $pq->getWillingToListen(); } ?>
</textarea>
                    </div>
                  </div>
                </div>
              ...
              <div class="dabblePageSection dabblePageSectionFull">
                <div class="dabblePageColumn dabblePageColumn1">
                  ...
                  <div class="dabblePageFormItem">
                    ...
                    <div class="dabblePageFormField">
                      <input id="w2286" name="questionnaire[therapy]" class=
                      "text text text" value="<?php if(isset($pq)){ echo $pq->getTherapyDetails(); } ?>" type="text" />
                    </div>
                  </div>
                  ...
                  <div class="dabblePageFormItem">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[therapy_impact]"><?php if(isset($pq)){ echo $pq->getTherapyImpact(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    <div class="dabblePageFormLabel">
                      <label for="w2346">Do you currently have, or have you ever had a coach?*</label>
                    </div>
                  ...
                  <div class="dabblePageFormItem">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[coaching_impact]"><?php if(isset($pq)){ echo $pq->getCoachingImpact(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[spiritual_influences]"><?php if(isset($pq)){ echo $pq->getReligiousAffiliations(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[spiritual_path]"><?php if(isset($pq)){ echo $pq->getReligiousInfluences(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[personal_growth]"><?php if(isset($pq)){ echo $pq->getGrowthExperiences(); } ?>
</textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="dabblePageColumn dabblePageColumn1">
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      ...
                      <p>This Co-Active Leadership Retreat is a unique opportunity to engage in a rigorous, dynamic and life changing experience that will challenge and stretch you.&nbsp; As with most things, the level to which you expand will be directly proportional to your level of engagement. The lion's share of the learning from this retreat will occur from interactions with your colleagues. They are counting on you for learning as much as you will be counting on them.</p>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[leadership]"><?php if(isset($pq)){ echo $pq->getImpactAsALeader(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[longing_to_expand]"><?php if(isset($pq)){ echo $pq->getChallenge(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[why_this_program]"><?php if(isset($pq)){ echo $pq->getWhyThisProgram(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
<!-- removed for MCC stand alone questionare
...
-->
                      <p>Considering your current life and commitments, how available are you to play &ldquo;full out&rdquo; in this Co-Active Leadership Retreat on a scale of 1 to 10 (10 being the highest)?</p>
                    </div>
                  </div>
...
<!-- removed for MCC stand alone questionare (extra spaces have been added to the php code to avoid it use)
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[what_if_would_take]">< ? php if(isset($pq)){ echo $pq->getWhatWouldItTake(); } ? >
</textarea>
                    </div>
                  </div>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[bringing_yourself_back]"> < ? php if(isset($pq)){ echo $pq->getBringYourselfBack(); } ? >
</textarea>
                    </div>
                  </div>
-->
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[going_the_distance]"><?php if(isset($pq)){ echo $pq->getGoingTheDistance(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      <p>Continuing the exploration of the impact you want to have as a leader, please complete the following sentence (By the way, we'll be re-visiting this question frequently during the retreat):</p>
                  ...
                  "dabblePageFormItem dabblePageFormItemRequired">
                    ...
                    <div class="dabblePageFormField">
                      ...
                      "questionnaire[purpose]"><?php if(isset($pq)){ echo $pq->getIWasBornTo(); } ?>
</textarea>
                    </div>
                  </div>
                  ...
                  <div class="dabblePageTextItem">
                    <div class="dabblePageText">
                      <p><em>Thank you for the time and attention that you have given to this questionnaire. As we stated at the beginning, your journey begins now. We encourage you to stay awake and aware to the ways in which the learning is already unfolding. Pay attention to the subtle shifts in your life: it is natural when you begin a retreat that holds out the opportunity for such change that you will experience a widening range of thoughts, emotions, and behaviors. You might notice new awareness, synchronicities, unforeseen opportunities, unexpected anxiety or even some resistance. Have room for whatever comes up for you.&nbsp; We encourage you to reach out to others for support and encouragement.&nbsp; Keep going...it will be worth it, we promise!</em></p>
                    </div>
                  </div>
