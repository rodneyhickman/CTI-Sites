...
/**
 * This class defines the structure of the 'pod' table.
 *
 *
 ...
 */
class PodTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PodTableMap';
	...
	{
    $this->addRelation('PodParticipant', 'PodParticipant', RelationMap::ONE_TO_MANY, array('id' => 'pod_id', ), 'CASCADE', null);
	} // buildRelations()
