...
abstract class BaseClient extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the using_version field.
	 * @var        string
	 */
	protected $using_version;

	/**
	 * The value for the client_using_features field.
	 * @var        string
	 */
	protected $client_using_features;
	...
	/**
	 * The value for the subscription_plan_id field.
	 * @var        string
	 */
	protected $subscription_plan_id;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collCategorys.
	 */
	private $lastCategoryCriteria = null;

	/**
	 * @var        array Workshop[] Collection to store aggregation of Workshop objects.
	 */
	protected $collWorkshops;

	/**
	 * @var        Criteria The criteria used to select the current contents of collWorkshops.
	 */
	private $lastWorkshopCriteria = null;
	...
	/**
	 * Get the [using_version] column value.
	 * 
	 * @return     string
	 */
	public function getUsingVersion()
	{
		return $this->using_version;
	}

	/**
	 * Get the [client_using_features] column value.
	 * 
	 * @return     string
	 */
	public function getClientUsingFeatures()
	{
		return $this->client_using_features;
	}
	...
	/**
	 * Get the [subscription_plan_id] column value.
	 * 
	 * @return     string
	 */
	...
	public function setSfGuardUserId($v)
	{
		...
		if ($this->sf_guard_user_id !== $v) {
			...
			$this->modifiedColumns[] = ClientPeer::SF_GUARD_USER_ID;
		}
	...
	public function setAddressLine1($v)
	{
		...
		if ($this->address_line1 !== $v) {
			...
			$this->modifiedColumns[] = ClientPeer::ADDRESS_LINE1;
		}
	...
	public function setAddressLine2($v)
	{
		...
		if ($this->address_line2 !== $v) {
			...
			$this->modifiedColumns[] = ClientPeer::ADDRESS_LINE2;
		}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v) {
			$this->country = $v;
			$this->modifiedColumns[] = ClientPeer::COUNTRY;
		}
	...
	public function setContactName($v)
	{
		...
		if ($this->contact_name !== $v) {
			$this->contact_name = $v;
			$this->modifiedColumns[] = ClientPeer::CONTACT_NAME;
		}
	...
	/**
	 * Set the value of [using_version] column.
	 * 
	 * @param      string $v new value
	 * @return     Client The current object (for fluent API support)
	 */
	public function setUsingVersion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->using_version !== $v) {
			$this->using_version = $v;
			$this->modifiedColumns[] = ClientPeer::USING_VERSION;
		}
	...
	/**
	 * Set the value of [client_using_features] column.
	 * 
	 * @param      string $v new value
	 * @return     Client The current object (for fluent API support)
	 */
	public function setClientUsingFeatures($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->client_using_features !== $v) {
			$this->client_using_features = $v;
			$this->modifiedColumns[] = ClientPeer::CLIENT_USING_FEATURES;
		}

		return $this;
	} // setClientUsingFeatures()
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = ClientPeer::STATUS;
		}
	...
	public function setSubscriberId($v)
	{
		...
		if ($this->subscriber_id !== $v) {
			...
			$this->modifiedColumns[] = ClientPeer::SUBSCRIBER_ID;
		}
	...
	/**
	 * Set the value of [subscription_plan_id] column.
	 * 
	 * @param      string $v new value
	 * @return     Client The current object (for fluent API support)
	 */
	public function setSubscriptionPlanId($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->subscription_plan_id !== $v) {
			$this->subscription_plan_id = $v;
			$this->modifiedColumns[] = ClientPeer::SUBSCRIPTION_PLAN_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->client_email = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			$this->work_phone = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->contact_name = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->using_version = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->client_using_features = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->status = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->subscriber_id = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->subscription_plan_id = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			...
			return $startcol + 19; // 19 = ClientPeer::NUM_COLUMNS - ClientPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collWorkshops = null;
			$this->lastWorkshopCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collWorkshops !== null) {
				foreach ($this->collWorkshops as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				return $this->getUsingVersion();
				break;
			case 13:
				return $this->getClientUsingFeatures();
				break;
			case 14:
			...
			case 15:
				...
				break;
			case 16:
				return $this->getSubscriptionPlanId();
				break;
			case 17:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getWorkPhone(),
			$keys[11] => $this->getContactName(),
			$keys[12] => $this->getUsingVersion(),
			$keys[13] => $this->getClientUsingFeatures(),
			$keys[14] => $this->getStatus(),
			$keys[15] => $this->getSubscriberId(),
			$keys[16] => $this->getSubscriptionPlanId(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				$this->setUsingVersion($value);
				break;
			case 13:
				$this->setClientUsingFeatures($value);
				break;
			case 14:
			...
			case 15:
				...
				break;
			case 16:
				$this->setSubscriptionPlanId($value);
				break;
			case 17:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setClientEmail($arr[$keys[2]]);
		...
		if (array_key_exists($keys[10], $arr)) $this->setWorkPhone($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setContactName($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setUsingVersion($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setClientUsingFeatures($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setStatus($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setSubscriberId($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setSubscriptionPlanId($arr[$keys[16]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientPeer::SF_GUARD_USER_ID)) $criteria->add(ClientPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
		...
		if ($this->isColumnModified(ClientPeer::ADDRESS_LINE1)) $criteria->add(ClientPeer::ADDRESS_LINE1, $this->address_line1);
		if ($this->isColumnModified(ClientPeer::ADDRESS_LINE2)) $criteria->add(ClientPeer::ADDRESS_LINE2, $this->address_line2);
		...
		if ($this->isColumnModified(ClientPeer::COUNTRY)) $criteria->add(ClientPeer::COUNTRY, $this->country);
		if ($this->isColumnModified(ClientPeer::WORK_PHONE)) $criteria->add(ClientPeer::WORK_PHONE, $this->work_phone);
		if ($this->isColumnModified(ClientPeer::CONTACT_NAME)) $criteria->add(ClientPeer::CONTACT_NAME, $this->contact_name);
		if ($this->isColumnModified(ClientPeer::USING_VERSION)) $criteria->add(ClientPeer::USING_VERSION, $this->using_version);
		if ($this->isColumnModified(ClientPeer::CLIENT_USING_FEATURES)) $criteria->add(ClientPeer::CLIENT_USING_FEATURES, $this->client_using_features);
		if ($this->isColumnModified(ClientPeer::STATUS)) $criteria->add(ClientPeer::STATUS, $this->status);
		if ($this->isColumnModified(ClientPeer::SUBSCRIBER_ID)) $criteria->add(ClientPeer::SUBSCRIBER_ID, $this->subscriber_id);
		if ($this->isColumnModified(ClientPeer::SUBSCRIPTION_PLAN_ID)) $criteria->add(ClientPeer::SUBSCRIPTION_PLAN_ID, $this->subscription_plan_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setClientEmail($this->client_email);
		...
		$copyObj->setUsingVersion($this->using_version);

		$copyObj->setClientUsingFeatures($this->client_using_features);

		$copyObj->setStatus($this->status);

		$copyObj->setSubscriberId($this->subscriber_id);

		$copyObj->setSubscriptionPlanId($this->subscription_plan_id);
		...
		if ($deepCopy) {
			...
			foreach ($this->getWorkshops() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addWorkshop($relObj->copy($deepCopy));
				}
			}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->sf_guard_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addClients($this);
			 */
		}
	...
	/**
	 * Clears out the collCategorys collection (array).
	 *
	...
	/**
	 * Initializes the collCategorys collection (array).
	 *
	 ...
	 * related Categorys from storage. If this Client is new, it will return
		...
		if ($this->collCategorys === null) {
			if ($this->isNew()) {
			   $this->collCategorys = array();
				...
				$criteria->add(CategoryPeer::CLIENT_ID, $this->id);
	...
	public function addCategory(Category $l)
	{
		...
		if (!in_array($l, $this->collCategorys, true)) { // only add it if the **same** object is not already associated
			array_push($this->collCategorys, $l);
			$l->setClient($this);
		}
	}

	/**
	 * Clears out the collWorkshops collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addWorkshops()
	 */
	public function clearWorkshops()
	{
		$this->collWorkshops = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWorkshops collection (array).
	 *
	 * By default this just sets the collWorkshops collection to an empty array (like clearcollWorkshops());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initWorkshops()
	{
		$this->collWorkshops = array();
	}

	/**
	 * Gets an array of Workshop objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Client has previously been saved, it will retrieve
	 * related Workshops from storage. If this Client is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getWorkshops($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkshops === null) {
			if ($this->isNew()) {
			   $this->collWorkshops = array();
				...
				$criteria->add(WorkshopPeer::CLIENT_ID, $this->id);

				WorkshopPeer::addSelectColumns($criteria);
				$this->collWorkshops = WorkshopPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				WorkshopPeer::addSelectColumns($criteria);
				if (!isset($this->lastWorkshopCriteria) || !$this->lastWorkshopCriteria->equals($criteria)) {
					$this->collWorkshops = WorkshopPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastWorkshopCriteria = $criteria;
		return $this->collWorkshops;
	}

	/**
	 * Returns the number of related Workshop objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Workshop objects.
	 * @throws     PropelException
	 */
	public function countWorkshops(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collWorkshops === null) {
			if ($this->isNew()) {
				...
				$count = WorkshopPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastWorkshopCriteria) || !$this->lastWorkshopCriteria->equals($criteria)) {
					...
					$count = count($this->collWorkshops);
				}
			} else {
				$count = count($this->collWorkshops);
			}
	...
	/**
	 * Method called to associate a Workshop object to this object
	 * through the Workshop foreign key attribute.
	 *
	 * @param      Workshop $l Workshop
	 * @return     void
	 * @throws     PropelException
	 */
	public function addWorkshop(Workshop $l)
	{
		if ($this->collWorkshops === null) {
			$this->initWorkshops();
		}
		if (!in_array($l, $this->collWorkshops, true)) { // only add it if the **same** object is not already associated
			array_push($this->collWorkshops, $l);
			$l->setClient($this);
		}
	}
	 ...
	 * been saved, it will retrieve related Workshops from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Client.
	 */
	public function getWorkshopsJoinCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkshops === null) {
			if ($this->isNew()) {
				...
				$this->collWorkshops = WorkshopPeer::doSelectJoinCategory($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collWorkshops) {
				foreach ((array) $this->collWorkshops as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
