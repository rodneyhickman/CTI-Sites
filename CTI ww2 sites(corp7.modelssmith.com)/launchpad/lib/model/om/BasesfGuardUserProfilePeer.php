...
abstract class BasesfGuardUserProfilePeer {
	...
	/** the column name for the PROFILE_ATTRIBUTE field */
	const PROFILE_ATTRIBUTE = 'profile.PROFILE_ATTRIBUTE';

	/** the column name for the PROFILE_VALUE field */
	const PROFILE_VALUE = 'profile.PROFILE_VALUE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'ProfileAttribute', 'ProfileValue', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'profileAttribute', 'profileValue', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::PROFILE_ATTRIBUTE, self::PROFILE_VALUE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'profile_attribute', 'profile_value', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'ProfileAttribute' => 2, 'ProfileValue' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'profileAttribute' => 2, 'profileValue' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::PROFILE_ATTRIBUTE => 2, self::PROFILE_VALUE => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'profile_attribute' => 2, 'profile_value' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::PROFILE_ATTRIBUTE);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::PROFILE_VALUE);
