...
abstract class BaseConfigurationPeer {
	...
	/** the column name for the CONFIG_ATTRIBUTE field */
	const CONFIG_ATTRIBUTE = 'configuration.CONFIG_ATTRIBUTE';

	/** the column name for the CONFIG_VALUE field */
	const CONFIG_VALUE = 'configuration.CONFIG_VALUE';

	/** the column name for the COMMENT field */
	const COMMENT = 'configuration.COMMENT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ConfigAttribute', 'ConfigValue', 'Comment', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'configAttribute', 'configValue', 'comment', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CONFIG_ATTRIBUTE, self::CONFIG_VALUE, self::COMMENT, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'config_attribute', 'config_value', 'comment', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ConfigAttribute' => 1, 'ConfigValue' => 2, 'Comment' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'configAttribute' => 1, 'configValue' => 2, 'comment' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CONFIG_ATTRIBUTE => 1, self::CONFIG_VALUE => 2, self::COMMENT => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'config_attribute' => 1, 'config_value' => 2, 'comment' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ConfigurationPeer::CONFIG_ATTRIBUTE);
		$criteria->addSelectColumn(ConfigurationPeer::CONFIG_VALUE);
		$criteria->addSelectColumn(ConfigurationPeer::COMMENT);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigurationPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigurationPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigurationPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfigurationPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigurationPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigurationPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigurationPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfigurationPeer', $values, $con, $ret);
    }
