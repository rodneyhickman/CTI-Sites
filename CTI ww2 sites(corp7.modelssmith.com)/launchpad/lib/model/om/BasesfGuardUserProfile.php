...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the profile_attribute field.
	 * @var        string
	 */
	protected $profile_attribute;

	/**
	 * The value for the profile_value field.
	 * @var        string
	 */
	protected $profile_value;
	...
	/**
	 * Get the [profile_attribute] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [profile_value] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [profile_attribute] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setProfileAttribute($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->profile_attribute !== $v) {
			$this->profile_attribute = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::PROFILE_ATTRIBUTE;
		}
	...
	/**
	 * Set the value of [profile_value] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setProfileValue($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->profile_value !== $v) {
			$this->profile_value = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::PROFILE_VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profile_attribute = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->profile_value = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getProfileAttribute(),
			$keys[3] => $this->getProfileValue(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setProfileAttribute($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setProfileValue($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::PROFILE_ATTRIBUTE)) $criteria->add(sfGuardUserProfilePeer::PROFILE_ATTRIBUTE, $this->profile_attribute);
		if ($this->isColumnModified(sfGuardUserProfilePeer::PROFILE_VALUE)) $criteria->add(sfGuardUserProfilePeer::PROFILE_VALUE, $this->profile_value);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setProfileAttribute($this->profile_attribute);

		$copyObj->setProfileValue($this->profile_value);
