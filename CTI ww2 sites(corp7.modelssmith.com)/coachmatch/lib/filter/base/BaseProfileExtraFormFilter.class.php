...
/**
 * ProfileExtra filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
class BaseProfileExtraFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('profile_extra_filters[%s]');
