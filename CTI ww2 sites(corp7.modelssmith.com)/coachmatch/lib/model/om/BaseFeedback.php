...
abstract class BaseFeedback extends BaseObject  implements Persistent {
  ...
  const PEER = 'FeedbackPeer';
	...
	/**
	 * Initializes internal state of BaseFeedback object.
	 * @see        applyDefaults()
	 */
	...
	public function setProfileId($v)
	{
		...
		if ($this->profile_id !== $v) {
			$this->profile_id = $v;
			$this->modifiedColumns[] = FeedbackPeer::PROFILE_ID;
		}
	...
	public function setFeedbackDate($v)
	{
		...
		if ( $this->feedback_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = FeedbackPeer::FEEDBACK_DATE;
			}
	...
	public function setAttribute($v)
	{
		...
		if ($this->attribute !== $v) {
			$this->attribute = $v;
			$this->modifiedColumns[] = FeedbackPeer::ATTRIBUTE;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = FeedbackPeer::VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->attribute = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 7; // 7 = FeedbackPeer::NUM_COLUMNS - FeedbackPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setAttribute($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FeedbackPeer::PROFILE_ID)) $criteria->add(FeedbackPeer::PROFILE_ID, $this->profile_id);
		if ($this->isColumnModified(FeedbackPeer::FEEDBACK_DATE)) $criteria->add(FeedbackPeer::FEEDBACK_DATE, $this->feedback_date);
		if ($this->isColumnModified(FeedbackPeer::ATTRIBUTE)) $criteria->add(FeedbackPeer::ATTRIBUTE, $this->attribute);
		if ($this->isColumnModified(FeedbackPeer::VALUE)) $criteria->add(FeedbackPeer::VALUE, $this->value);
	...
	public function getProfile(PropelPDO $con = null)
	{
		if ($this->aProfile === null && ($this->profile_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aProfile->addFeedbacks($this);
			 */
		}
