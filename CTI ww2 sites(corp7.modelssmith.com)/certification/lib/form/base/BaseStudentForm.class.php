...
class BaseStudentForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'cpcc_cert_date'       => new sfWidgetFormDate(),
      'cpcc_grad'            => new sfWidgetFormInput(),
      'course_certification' => new sfWidgetFormInput(),
      'cti_faculty'          => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      ...
      'cpcc_cert_date'       => new sfValidatorDate(array('required' => false)),
      'cpcc_grad'            => new sfValidatorString(array('max_length' => 25, 'required' => false)),
      'course_certification' => new sfValidatorString(array('max_length' => 25, 'required' => false)),
      'cti_faculty'          => new sfValidatorString(array('max_length' => 25, 'required' => false)),
      'active'               => new sfValidatorString(array('max_length' => 25, 'required' => false)),
