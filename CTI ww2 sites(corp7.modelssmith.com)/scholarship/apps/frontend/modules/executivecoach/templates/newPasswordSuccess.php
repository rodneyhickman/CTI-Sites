...
<?php if($ok): ?>
<h1>Thank you</h1>
<p>Your new password has been saved. Please <a href="<?php echo url_for('executivecoach/login'); ?>">log in</a>.
...
<p>Please enter your new password</p>
 ...
 <form action="<?php echo url_for('executivecoach/newPasswordProcess'); ?>" method="POST">
