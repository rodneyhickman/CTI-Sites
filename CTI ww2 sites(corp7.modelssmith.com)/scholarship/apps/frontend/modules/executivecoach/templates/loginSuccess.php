...
<div style="padding:20px;">
    <h2>Executive Coach Form: Login</h2>
...
<?php endif ?>
 ...
 <form action="<?php echo url_for('executivecoach/loginProcess') ?>" method="POST">
...
<tr>
  ...
  <tr><td></td><td>
    <a href="<?php echo url_for('executivecoach/requestNewPassword') ?>">I&rsquo;m not able to login</a> 
  </td></tr>
  </table>
