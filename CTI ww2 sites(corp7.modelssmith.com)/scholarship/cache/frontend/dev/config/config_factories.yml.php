...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/www/ww2.thecoaches.com/scholarship/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/www/ww2.thecoaches.com/scholarship/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('launchpad_cookie'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/www/ww2.thecoaches.com/scholarship/cache/frontend/dev/template',
  'lifetime' => 86400,
