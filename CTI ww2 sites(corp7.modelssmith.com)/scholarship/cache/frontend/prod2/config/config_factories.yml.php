...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/www/ww2.thecoaches.com/scholarship/log/frontend_prod2.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/www/ww2.thecoaches.com/scholarship/cache/frontend/prod2/i18n',
  'lifetime' => 31556926,
  'prefix' => '/www/ww2.thecoaches.com/scholarship/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('launchpad_cookie'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'launchpad_cookie',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/www/ww2.thecoaches.com/scholarship/cache/frontend/prod2/template',
  'lifetime' => 86400,
  'prefix' => '/www/ww2.thecoaches.com/scholarship/apps/frontend/template',
)));
