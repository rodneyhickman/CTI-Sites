...
abstract class BaseProfileForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'perm_address1'      => new sfWidgetFormTextarea(),
      'perm_address2'      => new sfWidgetFormTextarea(),
      'perm_city'          => new sfWidgetFormTextarea(),
      'perm_state_prov'    => new sfWidgetFormTextarea(),
      'perm_zip_postcode'  => new sfWidgetFormTextarea(),
      'perm_country'       => new sfWidgetFormTextarea(),
      'other_address1'     => new sfWidgetFormTextarea(),
      'other_address2'     => new sfWidgetFormTextarea(),
      'other_city'         => new sfWidgetFormTextarea(),
      'other_state_prov'   => new sfWidgetFormTextarea(),
      'other_zip_postcode' => new sfWidgetFormTextarea(),
      'other_country'      => new sfWidgetFormTextarea(),
      ...
      'referred_by'        => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'perm_address1'      => new sfValidatorString(array('required' => false)),
      'perm_address2'      => new sfValidatorString(array('required' => false)),
      'perm_city'          => new sfValidatorString(array('required' => false)),
      'perm_state_prov'    => new sfValidatorString(array('required' => false)),
      'perm_zip_postcode'  => new sfValidatorString(array('required' => false)),
      'perm_country'       => new sfValidatorString(array('required' => false)),
      'other_address1'     => new sfValidatorString(array('required' => false)),
      'other_address2'     => new sfValidatorString(array('required' => false)),
      'other_city'         => new sfValidatorString(array('required' => false)),
      'other_state_prov'   => new sfValidatorString(array('required' => false)),
      'other_zip_postcode' => new sfValidatorString(array('required' => false)),
      'other_country'      => new sfValidatorString(array('required' => false)),
