...
if(count($records) == 0){
	...
	$event_date = $day_of_event_date.' '.date("M d, Y", strtotime($first_record->getField('ev_date_d')));
	...
	$enroll_date = $day_of_enroll_start_date.', '.date("M d, Y", strtotime($enroll_start_date)).",";
