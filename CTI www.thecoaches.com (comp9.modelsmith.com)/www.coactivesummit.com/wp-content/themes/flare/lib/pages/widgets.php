...
class BTP_Custom_Pages_Widget extends WP_Widget {
	...
	function BTP_Custom_Pages_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'btp_custom_pages_widget', __('BTP Custom Pages', 'btp_theme'), $widget_ops, $control_ops );
	}
...
class BTP_Related_Pages_Widget extends WP_Widget {
	...
	function BTP_Related_Pages_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'btp_related_pages_widget', __('BTP Related Pages', 'btp_theme'), $widget_ops, $control_ops );
	}
