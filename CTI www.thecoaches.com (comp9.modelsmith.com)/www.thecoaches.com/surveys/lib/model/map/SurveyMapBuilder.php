...
/**
 * This class adds structure of 'survey' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class SurveyMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(SurveyPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(SurveyPeer::TABLE_NAME);
		$tMap->setPhpName('Survey');
		$tMap->setClassname('Survey');
