...
/**
 * This class adds structure of 'leader' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class LeaderMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.LeaderMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(LeaderPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(LeaderPeer::TABLE_NAME);
		$tMap->setPhpName('Leader');
		$tMap->setClassname('Leader');
		...
		$tMap->addColumn('RETRIEVAL_KEY', 'RetrievalKey', 'LONGVARCHAR', false, null);
