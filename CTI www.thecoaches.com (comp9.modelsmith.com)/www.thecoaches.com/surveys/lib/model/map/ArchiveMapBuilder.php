...
class ArchiveMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('PROFILE_GROUP_ID', 'ProfileGroupId', 'INTEGER', 'profile_group', 'ID', false, null);

		$tMap->addForeignKey('QUESTION_ID', 'QuestionId', 'INTEGER', 'question', 'ID', false, null);

		$tMap->addColumn('RESPONSE', 'Response', 'LONGVARCHAR', false, null);
