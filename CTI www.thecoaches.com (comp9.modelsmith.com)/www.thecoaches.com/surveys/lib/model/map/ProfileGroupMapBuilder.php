...
/**
 * This class adds structure of 'profile_group' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class ProfileGroupMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ProfileGroupMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(ProfileGroupPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(ProfileGroupPeer::TABLE_NAME);
		$tMap->setPhpName('ProfileGroup');
		$tMap->setClassname('ProfileGroup');
