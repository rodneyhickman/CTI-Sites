...
abstract class BaseProfileGroup extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProfileGroupPeer';
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ProfileGroupPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ProfileGroupPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setExtra1($v)
	{
		...
		if ($this->extra1 !== $v) {
			$this->extra1 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA1;
		}
	...
	public function setExtra2($v)
	{
		...
		if ($this->extra2 !== $v) {
			$this->extra2 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA2;
		}
	...
	public function setExtra3($v)
	{
		...
		if ($this->extra3 !== $v) {
			$this->extra3 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA3;
		}
	...
	public function setExtra4($v)
	{
		...
		if ($this->extra4 !== $v) {
			$this->extra4 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA4;
		}
	...
	public function setExtra5($v)
	{
		...
		if ($this->extra5 !== $v) {
			$this->extra5 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA5;
		}
	...
	public function setExtra6($v)
	{
		...
		if ($this->extra6 !== $v) {
			$this->extra6 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA6;
		}
	...
	public function setExtra7($v)
	{
		...
		if ($this->extra7 !== $v) {
			$this->extra7 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA7;
		}
	...
	public function setExtra8($v)
	{
		...
		if ($this->extra8 !== $v) {
			$this->extra8 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA8;
		}
	...
	public function setExtra9($v)
	{
		...
		if ($this->extra9 !== $v) {
			$this->extra9 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA9;
		}
	...
	public function setExtra10($v)
	{
		...
		if ($this->extra10 !== $v) {
			$this->extra10 = $v;
			$this->modifiedColumns[] = ProfileGroupPeer::EXTRA10;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->extra1 = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->extra2 = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->extra3 = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->extra4 = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->extra5 = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->extra6 = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->extra7 = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->extra8 = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->extra9 = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->extra10 = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->resetModified();
			...
			return $startcol + 13; // 13 = ProfileGroupPeer::NUM_COLUMNS - ProfileGroupPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseProfileGroup:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			ProfileGroupPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseProfileGroup:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProfileGroup:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(ProfileGroupPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(ProfileGroupPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseProfileGroup:save:post') as $callable)
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ProfileGroupPeer::doInsert($this, $con);
					...
					$affectedRows += ProfileGroupPeer::doUpdate($this, $con);
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getExtra1(),
			$keys[4] => $this->getExtra2(),
			$keys[5] => $this->getExtra3(),
			$keys[6] => $this->getExtra4(),
			$keys[7] => $this->getExtra5(),
			$keys[8] => $this->getExtra6(),
			$keys[9] => $this->getExtra7(),
			$keys[10] => $this->getExtra8(),
			$keys[11] => $this->getExtra9(),
			$keys[12] => $this->getExtra10(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setExtra1($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setExtra2($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setExtra3($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setExtra4($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setExtra5($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setExtra6($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setExtra7($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setExtra8($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setExtra9($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setExtra10($arr[$keys[12]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfileGroupPeer::CREATED_AT)) $criteria->add(ProfileGroupPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(ProfileGroupPeer::UPDATED_AT)) $criteria->add(ProfileGroupPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA1)) $criteria->add(ProfileGroupPeer::EXTRA1, $this->extra1);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA2)) $criteria->add(ProfileGroupPeer::EXTRA2, $this->extra2);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA3)) $criteria->add(ProfileGroupPeer::EXTRA3, $this->extra3);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA4)) $criteria->add(ProfileGroupPeer::EXTRA4, $this->extra4);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA5)) $criteria->add(ProfileGroupPeer::EXTRA5, $this->extra5);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA6)) $criteria->add(ProfileGroupPeer::EXTRA6, $this->extra6);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA7)) $criteria->add(ProfileGroupPeer::EXTRA7, $this->extra7);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA8)) $criteria->add(ProfileGroupPeer::EXTRA8, $this->extra8);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA9)) $criteria->add(ProfileGroupPeer::EXTRA9, $this->extra9);
		if ($this->isColumnModified(ProfileGroupPeer::EXTRA10)) $criteria->add(ProfileGroupPeer::EXTRA10, $this->extra10);
	 ...
	 * Otherwise if this ProfileGroup has previously been saved, it will retrieve
	 * related Answers from storage. If this ProfileGroup is new, it will return
		...
		if ($this->collAnswers === null) {
			if ($this->isNew()) {
			   $this->collAnswers = array();
				...
				$criteria->add(AnswerPeer::PROFILE_GROUP_ID, $this->id);
	 ...
	 */
	public function getAnswersJoinProfile($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfileGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswers === null) {
			if ($this->isNew()) {
				...
				$this->collAnswers = AnswerPeer::doSelectJoinProfile($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseProfileGroup:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseProfileGroup::%s', $method));
    }
