...
abstract class BaseArchive extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArchivePeer';
	...
	/**
	 * Initializes internal state of BaseArchive object.
	 * @see        applyDefaults()
	 */
	...
	public function setProfileId($v)
	{
		...
		if ($this->profile_id !== $v) {
			$this->profile_id = $v;
			$this->modifiedColumns[] = ArchivePeer::PROFILE_ID;
		}
	...
	public function setProfileGroupId($v)
	{
		...
		if ($this->profile_group_id !== $v) {
			...
			$this->modifiedColumns[] = ArchivePeer::PROFILE_GROUP_ID;
		}
	...
	public function setQuestionId($v)
	{
		...
		if ($this->question_id !== $v) {
			$this->question_id = $v;
			$this->modifiedColumns[] = ArchivePeer::QUESTION_ID;
		}
	...
	public function setResponse($v)
	{
		...
		if ($this->response !== $v) {
			$this->response = $v;
			$this->modifiedColumns[] = ArchivePeer::RESPONSE;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArchivePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setExtra1($v)
	{
		...
		if ($this->extra1 !== $v) {
			$this->extra1 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA1;
		}
	...
	public function setExtra2($v)
	{
		...
		if ($this->extra2 !== $v) {
			$this->extra2 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA2;
		}
	...
	public function setExtra3($v)
	{
		...
		if ($this->extra3 !== $v) {
			$this->extra3 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA3;
		}
	...
	public function setExtra4($v)
	{
		...
		if ($this->extra4 !== $v) {
			$this->extra4 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA4;
		}
	...
	public function setExtra5($v)
	{
		...
		if ($this->extra5 !== $v) {
			$this->extra5 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA5;
		}
	...
	public function setExtra6($v)
	{
		...
		if ($this->extra6 !== $v) {
			$this->extra6 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA6;
		}
	...
	public function setExtra7($v)
	{
		...
		if ($this->extra7 !== $v) {
			$this->extra7 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA7;
		}
	...
	public function setExtra8($v)
	{
		...
		if ($this->extra8 !== $v) {
			$this->extra8 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA8;
		}
	...
	public function setExtra9($v)
	{
		...
		if ($this->extra9 !== $v) {
			$this->extra9 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA9;
		}
	...
	public function setExtra10($v)
	{
		...
		if ($this->extra10 !== $v) {
			$this->extra10 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA10;
		}
	...
	public function setExtra11($v)
	{
		...
		if ($this->extra11 !== $v) {
			$this->extra11 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA11;
		}
	...
	public function setExtra12($v)
	{
		...
		if ($this->extra12 !== $v) {
			$this->extra12 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA12;
		}
	...
	public function setExtra13($v)
	{
		...
		if ($this->extra13 !== $v) {
			$this->extra13 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA13;
		}
	...
	public function setExtra14($v)
	{
		...
		if ($this->extra14 !== $v) {
			$this->extra14 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA14;
		}
	...
	public function setExtra15($v)
	{
		...
		if ($this->extra15 !== $v) {
			$this->extra15 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA15;
		}
	...
	public function setExtra16($v)
	{
		...
		if ($this->extra16 !== $v) {
			$this->extra16 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA16;
		}
	...
	public function setExtra17($v)
	{
		...
		if ($this->extra17 !== $v) {
			$this->extra17 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA17;
		}
	...
	public function setExtra18($v)
	{
		...
		if ($this->extra18 !== $v) {
			$this->extra18 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA18;
		}
	...
	public function setExtra19($v)
	{
		...
		if ($this->extra19 !== $v) {
			$this->extra19 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA19;
		}
	...
	public function setExtra20($v)
	{
		...
		if ($this->extra20 !== $v) {
			$this->extra20 = $v;
			$this->modifiedColumns[] = ArchivePeer::EXTRA20;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profile_group_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			$this->extra1 = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->extra2 = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->extra3 = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->extra4 = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->extra5 = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->extra6 = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->extra7 = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->extra8 = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->extra9 = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->extra10 = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->extra11 = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->extra12 = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->extra13 = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->extra14 = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->extra15 = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->extra16 = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->extra17 = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->extra18 = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->extra19 = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			$this->extra20 = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			$this->resetModified();
			...
			return $startcol + 27; // 27 = ArchivePeer::NUM_COLUMNS - ArchivePeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(ArchivePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(ArchivePeer::UPDATED_AT))
    {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getProfileGroupId(),
			$keys[3] => $this->getQuestionId(),
			$keys[4] => $this->getResponse(),
			$keys[5] => $this->getCreatedAt(),
			$keys[6] => $this->getUpdatedAt(),
			$keys[7] => $this->getExtra1(),
			$keys[8] => $this->getExtra2(),
			$keys[9] => $this->getExtra3(),
			$keys[10] => $this->getExtra4(),
			$keys[11] => $this->getExtra5(),
			$keys[12] => $this->getExtra6(),
			$keys[13] => $this->getExtra7(),
			$keys[14] => $this->getExtra8(),
			$keys[15] => $this->getExtra9(),
			$keys[16] => $this->getExtra10(),
			$keys[17] => $this->getExtra11(),
			$keys[18] => $this->getExtra12(),
			$keys[19] => $this->getExtra13(),
			$keys[20] => $this->getExtra14(),
			$keys[21] => $this->getExtra15(),
			$keys[22] => $this->getExtra16(),
			$keys[23] => $this->getExtra17(),
			$keys[24] => $this->getExtra18(),
			$keys[25] => $this->getExtra19(),
			$keys[26] => $this->getExtra20(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setProfileGroupId($arr[$keys[2]]);
		...
		if (array_key_exists($keys[7], $arr)) $this->setExtra1($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setExtra2($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setExtra3($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setExtra4($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setExtra5($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setExtra6($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setExtra7($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setExtra8($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setExtra9($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setExtra10($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setExtra11($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setExtra12($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setExtra13($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setExtra14($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setExtra15($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setExtra16($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setExtra17($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setExtra18($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setExtra19($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setExtra20($arr[$keys[26]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArchivePeer::PROFILE_ID)) $criteria->add(ArchivePeer::PROFILE_ID, $this->profile_id);
		if ($this->isColumnModified(ArchivePeer::PROFILE_GROUP_ID)) $criteria->add(ArchivePeer::PROFILE_GROUP_ID, $this->profile_group_id);
		if ($this->isColumnModified(ArchivePeer::QUESTION_ID)) $criteria->add(ArchivePeer::QUESTION_ID, $this->question_id);
		if ($this->isColumnModified(ArchivePeer::RESPONSE)) $criteria->add(ArchivePeer::RESPONSE, $this->response);
		if ($this->isColumnModified(ArchivePeer::CREATED_AT)) $criteria->add(ArchivePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(ArchivePeer::UPDATED_AT)) $criteria->add(ArchivePeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(ArchivePeer::EXTRA1)) $criteria->add(ArchivePeer::EXTRA1, $this->extra1);
		if ($this->isColumnModified(ArchivePeer::EXTRA2)) $criteria->add(ArchivePeer::EXTRA2, $this->extra2);
		if ($this->isColumnModified(ArchivePeer::EXTRA3)) $criteria->add(ArchivePeer::EXTRA3, $this->extra3);
		if ($this->isColumnModified(ArchivePeer::EXTRA4)) $criteria->add(ArchivePeer::EXTRA4, $this->extra4);
		if ($this->isColumnModified(ArchivePeer::EXTRA5)) $criteria->add(ArchivePeer::EXTRA5, $this->extra5);
		if ($this->isColumnModified(ArchivePeer::EXTRA6)) $criteria->add(ArchivePeer::EXTRA6, $this->extra6);
		if ($this->isColumnModified(ArchivePeer::EXTRA7)) $criteria->add(ArchivePeer::EXTRA7, $this->extra7);
		if ($this->isColumnModified(ArchivePeer::EXTRA8)) $criteria->add(ArchivePeer::EXTRA8, $this->extra8);
		if ($this->isColumnModified(ArchivePeer::EXTRA9)) $criteria->add(ArchivePeer::EXTRA9, $this->extra9);
		if ($this->isColumnModified(ArchivePeer::EXTRA10)) $criteria->add(ArchivePeer::EXTRA10, $this->extra10);
		if ($this->isColumnModified(ArchivePeer::EXTRA11)) $criteria->add(ArchivePeer::EXTRA11, $this->extra11);
		if ($this->isColumnModified(ArchivePeer::EXTRA12)) $criteria->add(ArchivePeer::EXTRA12, $this->extra12);
		if ($this->isColumnModified(ArchivePeer::EXTRA13)) $criteria->add(ArchivePeer::EXTRA13, $this->extra13);
		if ($this->isColumnModified(ArchivePeer::EXTRA14)) $criteria->add(ArchivePeer::EXTRA14, $this->extra14);
		if ($this->isColumnModified(ArchivePeer::EXTRA15)) $criteria->add(ArchivePeer::EXTRA15, $this->extra15);
		if ($this->isColumnModified(ArchivePeer::EXTRA16)) $criteria->add(ArchivePeer::EXTRA16, $this->extra16);
		if ($this->isColumnModified(ArchivePeer::EXTRA17)) $criteria->add(ArchivePeer::EXTRA17, $this->extra17);
		if ($this->isColumnModified(ArchivePeer::EXTRA18)) $criteria->add(ArchivePeer::EXTRA18, $this->extra18);
		if ($this->isColumnModified(ArchivePeer::EXTRA19)) $criteria->add(ArchivePeer::EXTRA19, $this->extra19);
		if ($this->isColumnModified(ArchivePeer::EXTRA20)) $criteria->add(ArchivePeer::EXTRA20, $this->extra20);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setProfileGroupId($this->profile_group_id);
	...
	public function getProfileGroup(PropelPDO $con = null)
	{
		if ($this->aProfileGroup === null && ($this->profile_group_id !== null)) {
			$c = new Criteria(ProfileGroupPeer::DATABASE_NAME);
			$c->add(ProfileGroupPeer::ID, $this->profile_group_id);
			$this->aProfileGroup = ProfileGroupPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aProfileGroup->addAnswers($this);
			 */
		}
