...
abstract class BaseQuestion extends BaseObject  implements Persistent {
  ...
  const PEER = 'QuestionPeer';
	...
	/**
	 * The value for the is_range field.
	 * @var        string
	 */
	protected $is_range;

	/**
	 * The value for the source_text field.
	 * @var        string
	 */
	...
	/**
	 * Get the [source_text] column value.
	 * 
	 * @return     string
	 */
	...
	public function setSurveyId($v)
	{
		...
		if ($this->survey_id !== $v) {
			$this->survey_id = $v;
			$this->modifiedColumns[] = QuestionPeer::SURVEY_ID;
		}
	...
	public function setHeading($v)
	{
		...
		if ($this->heading !== $v) {
			$this->heading = $v;
			$this->modifiedColumns[] = QuestionPeer::HEADING;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = QuestionPeer::CONTENT;
		}
	...
	public function setNextId($v)
	{
		...
		if ($this->next_id !== $v) {
			$this->next_id = $v;
			$this->modifiedColumns[] = QuestionPeer::NEXT_ID;
		}
	...
	/**
	 * Set the value of [is_range] column.
	 * 
	 * @param      string $v new value
	 * @return     Question The current object (for fluent API support)
	 */
	public function setIsRange($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->is_range !== $v) {
			$this->is_range = $v;
			$this->modifiedColumns[] = QuestionPeer::IS_RANGE;
		}
	...
	/**
	 * Set the value of [source_text] column.
	 * 
	 * @param      string $v new value
	 * @return     Question The current object (for fluent API support)
	 */
	public function setSourceText($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->source_text !== $v) {
			$this->source_text = $v;
			$this->modifiedColumns[] = QuestionPeer::SOURCE_TEXT;
		}
	...
	public function setExtra1($v)
	{
		...
		if ($this->extra1 !== $v) {
			$this->extra1 = $v;
			$this->modifiedColumns[] = QuestionPeer::EXTRA1;
		}
	...
	public function setExtra2($v)
	{
		...
		if ($this->extra2 !== $v) {
			$this->extra2 = $v;
			$this->modifiedColumns[] = QuestionPeer::EXTRA2;
		}
	...
	public function setExtra3($v)
	{
		...
		if ($this->extra3 !== $v) {
			$this->extra3 = $v;
			$this->modifiedColumns[] = QuestionPeer::EXTRA3;
		}
	...
	public function setExtra4($v)
	{
		...
		if ($this->extra4 !== $v) {
			$this->extra4 = $v;
			$this->modifiedColumns[] = QuestionPeer::EXTRA4;
		}
	...
	public function setExtra5($v)
	{
		...
		if ($this->extra5 !== $v) {
			$this->extra5 = $v;
			$this->modifiedColumns[] = QuestionPeer::EXTRA5;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->heading = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->content = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->next_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->is_range = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->source_text = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 14; // 14 = QuestionPeer::NUM_COLUMNS - QuestionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getHeading(),
			$keys[3] => $this->getContent(),
			$keys[4] => $this->getNextId(),
			$keys[5] => $this->getIsRange(),
			$keys[6] => $this->getSourceText(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setIsRange($value);
				break;
			case 6:
				$this->setSourceText($value);
				break;
			case 7:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setHeading($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setContent($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setNextId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setIsRange($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setSourceText($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuestionPeer::SURVEY_ID)) $criteria->add(QuestionPeer::SURVEY_ID, $this->survey_id);
		if ($this->isColumnModified(QuestionPeer::HEADING)) $criteria->add(QuestionPeer::HEADING, $this->heading);
		if ($this->isColumnModified(QuestionPeer::CONTENT)) $criteria->add(QuestionPeer::CONTENT, $this->content);
		if ($this->isColumnModified(QuestionPeer::NEXT_ID)) $criteria->add(QuestionPeer::NEXT_ID, $this->next_id);
		if ($this->isColumnModified(QuestionPeer::IS_RANGE)) $criteria->add(QuestionPeer::IS_RANGE, $this->is_range);
		if ($this->isColumnModified(QuestionPeer::SOURCE_TEXT)) $criteria->add(QuestionPeer::SOURCE_TEXT, $this->source_text);
		...
		if ($this->isColumnModified(QuestionPeer::EXTRA1)) $criteria->add(QuestionPeer::EXTRA1, $this->extra1);
		if ($this->isColumnModified(QuestionPeer::EXTRA2)) $criteria->add(QuestionPeer::EXTRA2, $this->extra2);
		if ($this->isColumnModified(QuestionPeer::EXTRA3)) $criteria->add(QuestionPeer::EXTRA3, $this->extra3);
		if ($this->isColumnModified(QuestionPeer::EXTRA4)) $criteria->add(QuestionPeer::EXTRA4, $this->extra4);
		if ($this->isColumnModified(QuestionPeer::EXTRA5)) $criteria->add(QuestionPeer::EXTRA5, $this->extra5);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNextId($this->next_id);

		$copyObj->setIsRange($this->is_range);

		$copyObj->setSourceText($this->source_text);
	...
	public function getSurvey(PropelPDO $con = null)
	{
		if ($this->aSurvey === null && ($this->survey_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aSurvey->addQuestions($this);
			 */
		}
		return $this->aSurvey;
	}
	 ...
	 * actually need in Question.
	 */
	public function getAnswersJoinProfileGroup($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(QuestionPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswers === null) {
			if ($this->isNew()) {
				...
				$this->collAnswers = AnswerPeer::doSelectJoinProfileGroup($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
