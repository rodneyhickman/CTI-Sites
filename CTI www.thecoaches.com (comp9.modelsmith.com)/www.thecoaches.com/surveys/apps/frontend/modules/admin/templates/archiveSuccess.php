...
<p><a href="<?php echo url_for('admin/archive?survey_id='.$survey_id.'&alpha_sort=1') ?>">&raquo; Sort by first name</a></p>
<p><a href="<?php echo url_for('admin/archive?survey_id='.$survey_id.'&alpha_sort=0') ?>">&raquo; Sort by most recent</a></p>
...
<tr>
<td><a href="<?php echo url_for('admin/leaderarchive') ?>?key=<?php echo $value['leader_retrieval_key'] ?>&survey_id=<?php echo $survey_id ?>"><?php echo $name ?></a></td>
