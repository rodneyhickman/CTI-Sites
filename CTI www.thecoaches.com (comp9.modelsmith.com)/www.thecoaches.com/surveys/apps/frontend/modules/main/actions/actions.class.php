...
class mainActions extends sfActions
{
  ...
  */
  ...
  public function executeLogin(sfWebRequest $request)
  {
    ...
    $this->redirect = $this->getUser()->getAttribute('redirect');
    if($this->redirect == ''){
  ...
  public function executeLoginProcess(sfWebRequest $request)
  {
    ...
    if(preg_match('/login/',$redirect)){
      // redirect to survey selector form/index?id=0
      $redirect = 'http://www.thecoaches.com/surveys/form/index?id=1';
    }
    ...
    $this->getUser()->setAttribute('redirect',$redirect);
