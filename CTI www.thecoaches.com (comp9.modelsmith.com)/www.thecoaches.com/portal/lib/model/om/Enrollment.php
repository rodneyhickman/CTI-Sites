...
To register for this call, please log on to the Student Portal http://www.thecoaches.com/portal/main/login
...
In the event you want to change or view your registration status (e.g. cancel, change the date), please log on to the Student Portal at http://www.thecoaches.com/portal/main/login.
Sincerely,
CTI Customer Service
...
Please note: As an assistant we request that you arrive one hour prior to the course start time each day.
...
Please note: To accept your assisting position please follow these steps:

	1.Login to the Student Portal
	2.Drop your waitlist position
	3.Re-register yourself to assist

If you find yourself waitlisted again it is due to the position already being accepted by another student. Best of luck!
