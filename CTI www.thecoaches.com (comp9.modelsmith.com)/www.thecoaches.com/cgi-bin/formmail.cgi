...
@referers = ('thecoaches.com','cticoach.com','coactivespace.com','modelsmith.com','techcoachtom.com');
...
sub parse_form {
    ...
    %Config = ('recipient','',          'subject','',
               'email','webmaster@thecoaches.com',              'realname','',
               'redirect','',           'bgcolor','',
...
sub send_mail {
    ...
    $MAIL .= "Below is the result of your feedback form.  It was submitted by\n";
    $MAIL .= "$Config{'realname'} ($Config{'email'}) on $date\n";
    $MAIL .= "-" x 75 . "\n\n";
...
#    if ($Config{'subject'}) { $MAIL .= "Subject: $Config{'subject'}\n\n" }
#    else                    { $MAIL .= "Subject: WWW Form Submission\n\n" }

#    close (MAIL);

  my %mail = (  To      => $Config{'recipient'},
                From    => $Config{'email'},
                Message => $MAIL,
