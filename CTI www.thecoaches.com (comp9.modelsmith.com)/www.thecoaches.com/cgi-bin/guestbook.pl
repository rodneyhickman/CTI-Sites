...
##############################################################################
# Set Variables
$guestbookurl = "http://www.majornet.com/~coach/guestbook.html";
$guestbookreal = "/clients/coach/public_html/guestbook.html";
$guestlog = "/clients/coach/public_html/guestlog.html";
$cgiurl = "/cgi-bin/cgiwrap/coach/guestbook.pl";
...
$recipient = 'coach@thecoaches.com';
...
sub no_comments {
   ...
   print "<body TEXT= #003333 BGCOLOR= #FFFFFF>\n";
			print "<TABLE BORDER=0 WIDTH=450 HEIGHT=100><TR><TD>\n";
			print "<h1>Your Comments appear to be blank</h1>\n";
...
sub no_name {
   ...
   print "<body TEXT= # 003333 BGCOLOR= #FFFFFF>\n";
			print "<TABLE BORDER=0 WIDTH=450 HEIGHT=100><TR><TD>\n";
			print "<h1>Your Name appears to be blank</h1>\n";
