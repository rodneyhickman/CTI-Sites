...
<?php
	session_start();
	$filename = "http://www.thecoaches.com/leadershiptribe/log/cti-leadership-tribe-loginLT-diagnostics.log";
	...
	If ($_SESSION['logged_in'] != 'yes') { 
		...
		// end diagnostic
		header("Location: http://www.thecoaches.com/leadershiptribe/loginLT.html?redirect=".$_SESSION['org_referer']);
		exit;	
	} else {
		/* already logged in */
