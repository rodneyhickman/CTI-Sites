...
/**
 * This class adds structure of 'calendar' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class CalendarMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.CalendarMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(CalendarPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(CalendarPeer::TABLE_NAME);
		$tMap->setPhpName('Calendar');
		$tMap->setClassname('Calendar');
