...
class EventMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('COURSE_TYPE_ID', 'CourseTypeId', 'INTEGER', false, null);
