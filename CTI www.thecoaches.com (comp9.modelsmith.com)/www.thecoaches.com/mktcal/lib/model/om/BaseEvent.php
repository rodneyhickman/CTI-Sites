...
abstract class BaseEvent extends BaseObject  implements Persistent {
  ...
  const PEER = 'EventPeer';
	...
	/**
	 * The value for the call_time field.
	 * @var        string
	 */
	protected $call_time;
	...
	/**
	 * The value for the pod_name field.
	 * @var        string
	 */
	protected $pod_name;
	...
	/**
	 * Get the [call_time] column value.
	 * 
	 * @return     string
	 */
	...
	public function setPublish($v)
	{
		...
		if ($this->publish !== $v) {
			$this->publish = $v;
			$this->modifiedColumns[] = EventPeer::PUBLISH;
		}
	...
	public function setRegion($v)
	{
		...
		if ($this->region !== $v) {
			$this->region = $v;
			$this->modifiedColumns[] = EventPeer::REGION;
		}
	...
	/**
	 * Set the value of [call_time] column.
	 * 
	 * @param      string $v new value
	 * @return     Event The current object (for fluent API support)
	 */
	public function setCallTime($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->call_time !== $v) {
			$this->call_time = $v;
			$this->modifiedColumns[] = EventPeer::CALL_TIME;
		}
	...
	/**
	 * Set the value of [pod_name] column.
	 * 
	 * @param      string $v new value
	 * @return     Event The current object (for fluent API support)
	 */
	public function setPodName($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->pod_name !== $v) {
			$this->pod_name = $v;
			$this->modifiedColumns[] = EventPeer::POD_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->course_type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			$this->publish = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->location = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->region = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->call_time = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->booking_link = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->description = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->pod_name = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->leader_name = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			...
			$this->extra1 = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->extra2 = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->extra3 = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->extra4 = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->extra5 = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->extra6 = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->extra7 = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->extra8 = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->extra9 = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			$this->extra10 = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			$this->extra11 = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
			$this->extra12 = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
			$this->extra13 = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
			$this->extra14 = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
			$this->extra15 = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
			$this->extra16 = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
			$this->extra17 = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
			$this->extra18 = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
			$this->extra19 = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
			$this->extra20 = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
			$this->resetModified();
			...
			return $startcol + 37; // 37 = EventPeer::NUM_COLUMNS - EventPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[9] => $this->getCallTime(),
			$keys[10] => $this->getBookingLink(),
			$keys[11] => $this->getDescription(),
			$keys[12] => $this->getPodName(),
			$keys[13] => $this->getLeaderName(),
			$keys[14] => $this->getUrl(),
			$keys[15] => $this->getCreatedAt(),
			$keys[16] => $this->getUpdatedAt(),
			$keys[17] => $this->getExtra1(),
			$keys[18] => $this->getExtra2(),
			$keys[19] => $this->getExtra3(),
			$keys[20] => $this->getExtra4(),
			$keys[21] => $this->getExtra5(),
			$keys[22] => $this->getExtra6(),
			$keys[23] => $this->getExtra7(),
			$keys[24] => $this->getExtra8(),
			$keys[25] => $this->getExtra9(),
			$keys[26] => $this->getExtra10(),
			$keys[27] => $this->getExtra11(),
			$keys[28] => $this->getExtra12(),
			$keys[29] => $this->getExtra13(),
			$keys[30] => $this->getExtra14(),
			$keys[31] => $this->getExtra15(),
			$keys[32] => $this->getExtra16(),
			$keys[33] => $this->getExtra17(),
			$keys[34] => $this->getExtra18(),
			$keys[35] => $this->getExtra19(),
			$keys[36] => $this->getExtra20(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setCourseTypeId($arr[$keys[2]]);
		...
		if (array_key_exists($keys[9], $arr)) $this->setCallTime($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setBookingLink($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDescription($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setPodName($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setLeaderName($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setUrl($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setCreatedAt($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setUpdatedAt($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setExtra1($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setExtra2($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setExtra3($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setExtra4($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setExtra5($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setExtra6($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setExtra7($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setExtra8($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setExtra9($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setExtra10($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setExtra11($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setExtra12($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setExtra13($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setExtra14($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setExtra15($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setExtra16($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setExtra17($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setExtra18($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setExtra19($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setExtra20($arr[$keys[36]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventPeer::PUBLISH)) $criteria->add(EventPeer::PUBLISH, $this->publish);
		if ($this->isColumnModified(EventPeer::LOCATION)) $criteria->add(EventPeer::LOCATION, $this->location);
		if ($this->isColumnModified(EventPeer::REGION)) $criteria->add(EventPeer::REGION, $this->region);
		if ($this->isColumnModified(EventPeer::CALL_TIME)) $criteria->add(EventPeer::CALL_TIME, $this->call_time);
		...
		if ($this->isColumnModified(EventPeer::POD_NAME)) $criteria->add(EventPeer::POD_NAME, $this->pod_name);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCallTime($this->call_time);

		$copyObj->setBookingLink($this->booking_link);

		$copyObj->setDescription($this->description);

		$copyObj->setPodName($this->pod_name);
