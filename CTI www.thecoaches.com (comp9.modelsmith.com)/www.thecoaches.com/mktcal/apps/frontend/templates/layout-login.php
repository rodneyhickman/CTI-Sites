...
font-size: 36px;
height: 55px;
background: url(/assets/img/banner-mask.png) no-repeat;
...
<body>
<div id="page">
  <img id="portraits" style="padding-top:25px;" src="/docs/images/course-materials-portraits.png" />
<div id="tools">
  <!-- generalID --><!-- -->
  <!-- eCommerceID --><!-- -->
...
<div id="broadcast">
  <img src="/docs/res/img/page-banners/content_mktcal.gif" width="920" alt="Coach Training" usemap="#logobutton" />
