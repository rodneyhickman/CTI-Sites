 ...
 */
class FormsField_columns_4 extends FormsField
{
	...
	public function render_field($field=array(), $template=TRUE, $data='')
	{
		...
		$out .= '</div>';
		$out .= '<div class="column sortable" data-number="3" style="width:'.$column_width_3.'">';
		...
		$out .= '<div class="column column-last sortable" data-number="4" style="width:'.$column_width_4.'">';
		if (isset($field['columns'][4]) === TRUE)
		{
			foreach ($field['columns'][4] as $html)
			{
				$out .= $html;
			}
	...
	public function field_settings($settings=array(), $template=TRUE)
	{
		...
		return $this->EE->load->view('fields/columns_4', $vData, TRUE);
	}
...
/* End of file field.columns_4.php */
/* Location: ./system/expressionengine/third_party/forms/fields/field.columns_4.php */
