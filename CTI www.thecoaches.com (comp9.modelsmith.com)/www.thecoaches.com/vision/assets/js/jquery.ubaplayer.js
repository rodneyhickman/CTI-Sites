...
(function($){
	var defaults = {
		...
		continuous:	false,
		extension:	null,
		flashAudioPlayerPath:	"/vision/assets/js/libs/swf/player.swf",
		flashExtension:	".mp3",
		...
		swfobjectPath:	"/vision/assets/js/libs/swfobject/swfobject.js",
		volume:	0.5
	},
	currentTrack,
	isPlaying = false,
		...
		init: function( options ){
			...
			if(isFlash){
				...
				$.getScript(defaults.swfobjectPath,function(){
					swfobject.embedSWF(defaults.flashAudioPlayerPath, defaults.playerContainer, "0", "0", "9.0.0", "/vision/assets/js/libs/swf/expressInstall.swf", false, false, {id:defaults.flashObjectID}, _methods.swfLoaded);
				});
			} else {
