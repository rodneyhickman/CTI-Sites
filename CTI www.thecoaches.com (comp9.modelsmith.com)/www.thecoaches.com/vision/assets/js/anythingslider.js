	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNavigation = function() {
			if (o.buildNavigation && (base.pages > 1)) {
				...
				base.$nav.children('li.tooltip').bind(o.clickControls, function(e) {
		...
		base.endAnimation = function(page, callback, time){
			...
			base.$items.removeClass('activePage').eq((page - base.adj)+1).addClass('activePage');
		...
		base.setCurrentPage = function(page, move) {
			...
			base.$currentPage = base.$items.removeClass('activePage').eq((page - base.adj)+1).addClass('activePage');
	...
	$.fn.anythingSliderFx = function(effects, options){
		...
		getBaseFx = function(s){
			...
			return {
				...
				'grow'   : [{ inFx: { top: 0, fontSize: size || '16px', opacity : .7 }, outFx: { top: '-200px', fontSize: size2 || '80px', opacity: 0 } }],
