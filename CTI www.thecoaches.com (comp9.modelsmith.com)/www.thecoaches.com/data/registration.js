...
CoursePackage.prototype.renderHeader = function(sing) {
    ...
    if(this.number == 3){
        html += this.header('Individual Course: Fundamentals','$925','','925.00','a-6814'); //Individual Course: 
    }
    if(this.number == 4){
    ...
    if(this.number == 12){
        html += this.header('Individual Course: Co-Active Sales','$795','','795','cart1161'); //Individual Course: 
    }
    if(this.number == 13){
...
CoursePackage.prototype.renderAdvisor = function() {
    ...
    var dropdown1 = new Dropdown('op30','op30',[ 
        ...
        {' Assisted by Sue Jordan':'Sue Jordan'}
    ] );
 ...
 */
 ...
 if(form.pkg && form.pkg.value=="01" && singaporeSelected(form) ){
   ...
   pro_price = 1600; pro_discount = 350;
   itb_price = 1600; itb_discount = 350;
   form.item.value = "a-6814^A3FULL^Co-Active Professional Co-Active Coach Pathway, USD $11,800 - Package B^1185.00^1^^^^^"; 
} 
