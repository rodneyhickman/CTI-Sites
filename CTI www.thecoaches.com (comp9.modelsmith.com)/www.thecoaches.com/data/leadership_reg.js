...
$html .= emit_registration( $NA_retreats, 
                            ...
                            'Northern California',
                            '<input type="hidden" name="itemnc" id="itemnc" value="a-6814^LP^Total Cost USD $13,950, Deposit USD $995 <br> Leadership Package Northern California^995.00^1^^^^^">',
                            'op1','op2'
);
...
$html .= emit_registration( $BOI_retreats, 
                            'East Coast, USA', 
                            'East Coast',
                            '<input type="hidden" name="itemec" id="itemec" value="a-6814^LP^Total Cost USD $13,950, Deposit USD $995 <br> Leadership Package East Coast^995.00^1^^^^^">',
                            'op3','op4'
                          );
...
$html .= emit_registration( $ES_retreats, 
                            'Sitges, Spain', 
                            'Sitges, Spain',
                            '<input type="hidden" name="itemsp" id="itemsp" value="a-6814^LP^Total Cost Euro 12,300, Deposit Euro 975	 <br> Leadership Package Spain^975.00^1^^^^^">',
                            'op5','op6'
                          );
...
$html .= emit_registration( $TR_retreats, 
                            'Istanbul, Turkey', 
                            'Istanbul, Turkey',
                            '<input type="hidden" name="itemtr" id="itemtr" value="a-6814^LP^Total Cost Euro 12,300, Deposit Euro 975	 <br> Leadership Package Turkey^975.00^1^^^^^">',
                            'op7','op8'
                          );
...
function addParams(form)
{
  ...
  if(op1v != ''){
    ...
    item=document.getElementById('itemtr').value;
  } 
...
html += '                <input type="radio" name="Payment Option" value="in full" checked>	In Full: $13,950 (US programs) or &euro;12,300 (European programs) due 3 weeks prior to the program start date</p>';
html += '              <p  style="text-indent:-17px; padding-left:17px;">';
html += '                <input type="radio" name="Payment Option" value="quarterly">	Quarterly: $2,494 (US programs) or &euro;2,100 (European programs) due prior to the first retreat ';
html += '                and in 3 additional installments of $3,487 or &euro;3,075 3 weeks prior to each retreat start date</p>';
html += '              <p  style="text-indent:-17px; padding-left:17px;">';
html += '                <input type="radio" name="Payment Option" value="monthly">	Monthly: approximately $1079.58 (US programs) or approximately &euro;943.50 (European programs) per month for 12 months, beginning 2 months prior to Retreat 1 (25% of the total program fees must be paid 3 weeks prior to each retreat start date)</p>';
html += '            </td>';
html += '          </tr>';
html += '';
html += '          <tr>';
