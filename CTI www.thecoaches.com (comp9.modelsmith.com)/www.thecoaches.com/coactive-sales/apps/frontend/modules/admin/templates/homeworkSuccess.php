<h1 class="short">Homework for <?php echo $profile->getName() ?></h1>
<h2>Week of <?php echo $homework->getWeekStartingFormatted() ?></h2>

   <p>&nbsp;<br />Complete this homework everyweek to track your progress</p>

<form class="homework-form" action="<?php echo url_for('admin/homeworkProcess') ?>" method="POST">
   <input type="hidden" name="profile_id"  value="<?php echo $profile->getId() ?>" />
   <input type="hidden" name="homework_id" value="<?php echo $homework->getId() ?>" />
