...
jQuery(document).ready(function(){
	...
	if (document.getElementById('EntriesDT') != null){
		...
		Forms.fBody.delegate('.DeleteFentry', 'click', Forms.DeleteFentry);
	}
...
Forms.DeleteFentry = function(Event){

	var Fentry_Id = $(Event.target).data('id');

	var answer = confirm("Are you sure you want to delete this entry?");
	if (answer){
		$.get(Forms.AJAX_URL, {fentry_id: Fentry_Id, ajax_method: 'delete_fentry'}, function(){
