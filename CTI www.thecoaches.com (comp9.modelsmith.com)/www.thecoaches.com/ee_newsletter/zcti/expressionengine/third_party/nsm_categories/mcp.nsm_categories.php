...
class Nsm_categories_mcp {

	public static $addon_id = NSM_CATEGORIES_ADDON_ID;
	...
	public function _renderLayout($page, $out = FALSE) {
		...
		$this->EE->cp->set_breadcrumb(self::_route(), $this->EE->lang->line('nsm_example_addon_module_name'));
	...
	public static function _route($method = 'index', $params = array(), $add_base = true) {
		...
		$params = array_merge(array(
			'C' =>  'addons_modules',
			'M' => 'show_module_cp',
			'module' => NSM_CATEGORIES_ADDON_ID,
			'method' => $method
		), $params);
