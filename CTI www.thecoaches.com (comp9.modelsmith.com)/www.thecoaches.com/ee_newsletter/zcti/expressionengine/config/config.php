...
$config['debug'] = "1";
$config['cp_url'] = 'http://www.thecoaches.com/ee_newsletter/admin.php';
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = 'y';
$config['site_label'] = 'CTI';
$config['cookie_prefix'] = '';
$config['site_url'] = 'http://www.thecoaches.com/';


// END EE config items

$config['ce_image_document_root'] = '/www/www.thecoaches.com/';
$config['ce_image_cache_dir'] = 'ee_newsletter/images/made/';
...
|
*/
$config['encryption_key'] = 'sjdhfiufkhsekugfhkajf';
...
|--------------------------------------------------------------------------
|
| This overrides the current autosave interval from 300 seconds to
| what is set below.
|
*/
$config['autosave_interval_seconds'] = '30000';
