...
abstract class BaseProfile extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProfilePeer';
	...
	/**
	 * @var        array Homework[] Collection to store aggregation of Homework objects.
	 */
	protected $collHomeworks;

	/**
	 * @var        Criteria The criteria used to select the current contents of collHomeworks.
	 */
	private $lastHomeworkCriteria = null;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collAudios.
	 */
	private $lastAudioCriteria = null;
	...
	public function setFmid($v)
	{
		...
		if ($this->fmid !== $v) {
			$this->fmid = $v;
			$this->modifiedColumns[] = ProfilePeer::FMID;
		}
	...
	public function setPurpose($v)
	{
		...
		if ($this->purpose !== $v) {
			$this->purpose = $v;
			$this->modifiedColumns[] = ProfilePeer::PURPOSE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->purpose = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 27; // 27 = ProfilePeer::NUM_COLUMNS - ProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastHomeworkCriteria = null;

			$this->collAudios = null;
			$this->lastAudioCriteria = null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPurpose($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilePeer::FMID)) $criteria->add(ProfilePeer::FMID, $this->fmid);
		...
		if ($this->isColumnModified(ProfilePeer::PURPOSE)) $criteria->add(ProfilePeer::PURPOSE, $this->purpose);
	...
	/**
	 * Clears out the collHomeworks collection (array).
	 *
	...
	/**
	 * Initializes the collHomeworks collection (array).
	 *
	 ...
	 * @return     void
	 */
	public function initHomeworks()
	{
		$this->collHomeworks = array();
	}

	/**
	 * Gets an array of Homework objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Profile has previously been saved, it will retrieve
	 * related Homeworks from storage. If this Profile is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getHomeworks($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilePeer::DATABASE_NAME);
		}
		...
		if ($this->collHomeworks === null) {
			if ($this->isNew()) {
			   $this->collHomeworks = array();
				...
				$criteria->add(HomeworkPeer::PROFILE_ID, $this->id);

				HomeworkPeer::addSelectColumns($criteria);
				$this->collHomeworks = HomeworkPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				HomeworkPeer::addSelectColumns($criteria);
				if (!isset($this->lastHomeworkCriteria) || !$this->lastHomeworkCriteria->equals($criteria)) {
					$this->collHomeworks = HomeworkPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastHomeworkCriteria = $criteria;
	 ...
	 * @throws     PropelException
	 */
	public function countHomeworks(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collHomeworks === null) {
			if ($this->isNew()) {
				...
				$count = HomeworkPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastHomeworkCriteria) || !$this->lastHomeworkCriteria->equals($criteria)) {
					...
					$count = count($this->collHomeworks);
				}
			} else {
				$count = count($this->collHomeworks);
			}
	...
	/**
	 * Method called to associate a Homework object to this object
	 * through the Homework foreign key attribute.
	 *
	 * @param      Homework $l Homework
	 * @return     void
	 * @throws     PropelException
	 */
	public function addHomework(Homework $l)
	{
		if ($this->collHomeworks === null) {
			$this->initHomeworks();
		}
		if (!in_array($l, $this->collHomeworks, true)) { // only add it if the **same** object is not already associated
			array_push($this->collHomeworks, $l);
			$l->setProfile($this);
		}
	}
	 ...
	 * been saved, it will retrieve related Homeworks from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Profile.
	 */
	public function getHomeworksJoinGroup($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilePeer::DATABASE_NAME);
		}
		...
		if ($this->collHomeworks === null) {
			if ($this->isNew()) {
				...
				$this->collHomeworks = HomeworkPeer::doSelectJoinGroup($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collAudios collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collAudios collection (array).
	 *
	 ...
	 * @return     void
	 */
	public function initAudios()
	{
		$this->collAudios = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Profile has previously been saved, it will retrieve
	 * related Audios from storage. If this Profile is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collAudios === null) {
			if ($this->isNew()) {
			   $this->collAudios = array();
				...
				$criteria->add(AudioPeer::PROFILE_ID, $this->id);

				AudioPeer::addSelectColumns($criteria);
				$this->collAudios = AudioPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				AudioPeer::addSelectColumns($criteria);
				if (!isset($this->lastAudioCriteria) || !$this->lastAudioCriteria->equals($criteria)) {
					$this->collAudios = AudioPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastAudioCriteria = $criteria;
	...
	public function countAudios(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collAudios === null) {
			if ($this->isNew()) {
				...
				$count = AudioPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addAudio(Audio $l)
	{
		...
		if (!in_array($l, $this->collAudios, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAudios, $l);
			$l->setProfile($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Profile has previously been saved, it will retrieve
	 * related Documents from storage. If this Profile is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collDocuments === null) {
			if ($this->isNew()) {
			   $this->collDocuments = array();
				...
				$criteria->add(DocumentPeer::PROFILE_ID, $this->id);
	...
	public function countDocuments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collDocuments === null) {
			if ($this->isNew()) {
				...
				$count = DocumentPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collHomeworks) {
				foreach ((array) $this->collHomeworks as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collAudios) {
				foreach ((array) $this->collAudios as $o) {
					$o->clearAllReferences($deep);
				}
			}
