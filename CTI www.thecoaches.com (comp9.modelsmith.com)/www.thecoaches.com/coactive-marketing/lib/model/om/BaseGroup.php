...
abstract class BaseGroup extends BaseObject  implements Persistent {
  ...
  const PEER = 'GroupPeer';
	...
	public function setStartDate($v)
	{
		...
		if ( $this->start_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GroupPeer::START_DATE;
			}
	...
	public function setExtra1($v)
	{
		...
		if ($this->extra1 !== $v) {
			$this->extra1 = $v;
			$this->modifiedColumns[] = GroupPeer::EXTRA1;
		}
	...
	public function setExtra2($v)
	{
		...
		if ($this->extra2 !== $v) {
			$this->extra2 = $v;
			$this->modifiedColumns[] = GroupPeer::EXTRA2;
		}
	...
	public function setExtra3($v)
	{
		...
		if ($this->extra3 !== $v) {
			$this->extra3 = $v;
			$this->modifiedColumns[] = GroupPeer::EXTRA3;
		}
	...
	public function setExtra4($v)
	{
		...
		if ($this->extra4 !== $v) {
			$this->extra4 = $v;
			$this->modifiedColumns[] = GroupPeer::EXTRA4;
		}
	...
	public function setExtra5($v)
	{
		...
		if ($this->extra5 !== $v) {
			$this->extra5 = $v;
			$this->modifiedColumns[] = GroupPeer::EXTRA5;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = GroupPeer::NUM_COLUMNS - GroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GroupPeer::START_DATE)) $criteria->add(GroupPeer::START_DATE, $this->start_date);
		...
		if ($this->isColumnModified(GroupPeer::EXTRA1)) $criteria->add(GroupPeer::EXTRA1, $this->extra1);
		if ($this->isColumnModified(GroupPeer::EXTRA2)) $criteria->add(GroupPeer::EXTRA2, $this->extra2);
		if ($this->isColumnModified(GroupPeer::EXTRA3)) $criteria->add(GroupPeer::EXTRA3, $this->extra3);
		if ($this->isColumnModified(GroupPeer::EXTRA4)) $criteria->add(GroupPeer::EXTRA4, $this->extra4);
		if ($this->isColumnModified(GroupPeer::EXTRA5)) $criteria->add(GroupPeer::EXTRA5, $this->extra5);
	 ...
	 * related Homeworks from storage. If this Group is new, it will return
		...
		if ($this->collHomeworks === null) {
			if ($this->isNew()) {
			   $this->collHomeworks = array();
				...
				$criteria->add(HomeworkPeer::GROUP_ID, $this->id);
	 ...
	 */
	public function getHomeworksJoinProfile($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collHomeworks === null) {
			if ($this->isNew()) {
				...
				$this->collHomeworks = HomeworkPeer::doSelectJoinProfile($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
