...
/**
 * This class adds structure of 'audio' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class AudioMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AudioMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(AudioPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(AudioPeer::TABLE_NAME);
		$tMap->setPhpName('Audio');
		$tMap->setClassname('Audio');
