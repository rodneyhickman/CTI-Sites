...
/**
 * This class adds structure of 'homework' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class HomeworkMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.HomeworkMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(HomeworkPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(HomeworkPeer::TABLE_NAME);
		$tMap->setPhpName('Homework');
		$tMap->setClassname('Homework');
		...
		$tMap->addForeignKey('GROUP_ID', 'GroupId', 'INTEGER', 'group', 'ID', false, null);

		$tMap->addColumn('WEEK_STARTING', 'WeekStarting', 'DATE', false, null);

		$tMap->addColumn('SS_COMMIT', 'SsCommit', 'INTEGER', false, null);

		$tMap->addColumn('SS_COMPLETED', 'SsCompleted', 'INTEGER', false, null);

		$tMap->addColumn('CLIENTS_COMMIT', 'ClientsCommit', 'INTEGER', false, null);

		$tMap->addColumn('CLIENTS_COMPLETED', 'ClientsCompleted', 'INTEGER', false, null);

		$tMap->addColumn('POINTS_COMMIT', 'PointsCommit', 'INTEGER', false, null);

		$tMap->addColumn('POINTS_EARNED', 'PointsEarned', 'INTEGER', false, null);
